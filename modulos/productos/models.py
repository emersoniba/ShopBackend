...
class Producto(AuditoriaBase):
    ...
    precio_oferta = models.DecimalField(
        "Precio oferta", max_digits=10, decimal_places=2, null=True, blank=True
    )
    ...
    # imagenes_adicionales = models.JSONField(upload_to="productos_ad/" ,null=True,blank=True)
    ...
    calificacion_promedio = models.DecimalField(
        "Calificación", max_digits=3, decimal_places=2, default=0
    )
